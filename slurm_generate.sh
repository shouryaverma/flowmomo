...
# # peptide
python generate.py --config configs/test/test_pep.yaml --ckpt /depot/natallah/data/shourya/flowmomo/ckpts/unimomo/Flow_unimomo/version_1/checkpoint/epoch169_step40290.ckpt --gpu 0 --save_dir ./results/pep
# # antibody
